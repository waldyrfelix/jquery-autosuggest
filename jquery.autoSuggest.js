...
(function ($) {
    $.fn.autoSuggest = function (data, options) {
        ...
        function parseData(data) {
            ...
            throw new Error('There is no data source associated.');
        }
        ...
        function remove (data) {
            values_input.val(values_input.val().replace("," + data[opts.selectedItemProp] + ",", ","));
            selections_holder.find('li[data-value = "' + data[opts.selectedItemProp] + '"]').remove();
        }
